...
export const PerfumeSchema = z.object({
  ...
  precios: z.array(z.number()).describe("Precio ORIGINAL (sin descuento) de cada variante, en el mismo orden que 'variantes'. En Shopify corresponde a compare_at_price/100. Si no hay descuento, usar price/100. Ej: 690000."),
  precios_descuento: z.array(z.number()).describe("Precio REBAJADO (lo que el cliente paga) de cada variante. En Shopify corresponde a price/100. Si no hay descuento, debe ser igual a precios[i]. Ej: 621000."),
