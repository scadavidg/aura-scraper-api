...
1. VARIANTES Y PRECIOS — LEE ESTO CON MÁXIMA ATENCIÓN:
   ...
   - ⛔ FORMATO OBLIGATORIO DEL TÍTULO: cada elemento de 'variantes' debe ser EXACTAMENTE 2 o 3 cifras seguidas de 'ML' y nada más (ej: '50 ML', '100 ML', '236 ML'). Si el título del proveedor trae cualquier otra cosa —un calificativo entre paréntesis, un texto pegado, o una sola cifra— esa variante NO va: descártala entera junto con su precio y disponibilidad.
       * SÍ: '50 ML', '100 ML', '200 ML', '236 ML'
       * NO: '5 ML (Decant)', '5 ML (Vial)', '75 ML (Tester)', '236 ML Body Spray', '60 ML Body Spray', '5 ML', '5ML', 'Set de regalo', 'Standard'
     Aplica en MAYÚSCULA o minúscula. Si incluyes una variante que no sea talla limpia cometerás un error grave.
